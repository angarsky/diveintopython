...
Если вы хотите прочитать все `files` в директории, используя Python, вы можете использовать модуль [os](https://docs.python.org/3/library/os.html). Вот два примера того, как выполнить эту задачу:
