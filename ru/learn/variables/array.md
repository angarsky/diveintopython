...
Оба подхода позволяют вам генерировать случайные массивы целых чисел. Настройте параметры (`a`, `b` и `size`) в зависимости от ваших конкретных требований, чтобы контролировать диапазон и размер случайного массива.
