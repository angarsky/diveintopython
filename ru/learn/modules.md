...
Python поставляется с множеством встроенных модулей как часть его стандартной библиотеки. Два наиболее часто используемых модуля в Python - это модуль [random](https://docs.python.org/3/library/random.html) и модуль [math](https://docs.python.org/3/library/math.html).
